...
```bash
curl -X GET "https://api.apiverve.com/v1/zipcodes?zip=64082" \
...
[**View RubyGems Package →**](https://rubygems.org/gems/apiverve_zipcodes) | [**Package Code →**](./ruby/)
...
[**View Packagist Package →**](https://packagist.org/packages/apiverve/zipcodes) | [**Package Code →**](./php/)
...
[**View pub.dev Package →**](https://pub.dev/packages/apiverve_zipcodes) | [**Package Code →**](./dart/)
